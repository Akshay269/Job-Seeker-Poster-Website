...
-- AlterEnum
BEGIN;
CREATE TYPE "ApplicationStatus_new" AS ENUM ('PENDING_REVIEW', 'SHORTLISTED', 'INTERVIEW_SCHEDULED', 'REJECTED');
...
ALTER TABLE "Application" ALTER COLUMN "status" SET DEFAULT 'PENDING_REVIEW';
COMMIT;
